...
// Form input class aliases → styles/components/form.css
export const baseControlClasses = "input-field__control";

export const priorityStyles = {
  Low: "input-field--priority-low",
  Medium: "input-field--priority-medium",
  High: "input-field--priority-high",
};
...
// LOGIN CSS
export const INPUTWRAPPER = "input-field";
export const BUTTON_CLASSES = "btn btn--primary btn--block";

// PROFILE CSS
export const INPUT_WRAPPER = "input-field";
export const FULL_BUTTON = "btn btn--primary btn--block";
...
export const DANGER_BTN = "btn btn--danger btn--block";
...
export const Inputwrapper = "input-field";
export const BUTTONCLASSES = "btn btn--primary btn--block";
export const MESSAGE_SUCCESS = "form-message form-message--success";
export const MESSAGE_ERROR = "form-message form-message--error";
...
export const ADD_BUTTON = "btn btn--primary";
...
export const SELECT_CLASSES = "input-field input-field--filter";
...
export const CT_CLASSES = {
  ...
  select: "input-field input-field--filter input-field--sm",
...
export const layoutClasses = {
  ...
  select: "input-field input-field--filter",
...
export const TI_CLASSES = {
  wrapper:
    "group flex p-4 sm:p-5 rounded-xl shadow-sm bg-white border-l-4 hover:shadow-md transition-all duration-300 border border-purple-100",
